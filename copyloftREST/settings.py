"""
Django settings for copyloftREST project.
...
SECRET_KEY = 'z0l$i!q9#b3j)p6lp(1@o)=3a&=r$wj$0jkag%@60=fotyvf&3'
...
ROOT_URLCONF = 'copyloftREST.urls'
...
WSGI_APPLICATION = 'copyloftREST.wsgi.application'
