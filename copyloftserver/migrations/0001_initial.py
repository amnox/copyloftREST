    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='copyloftserver.User')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='cart',
            name='user_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='copyloftserver.User'),
        ),
    ]
